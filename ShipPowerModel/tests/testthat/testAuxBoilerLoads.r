...
test_that("calcAuxBoilerLoad IMO works",
          {
            ...
            testIMOAuxBoilerLoad<-data.table::data.table(
              ...
              opMode=c(rep(c("Anchorage","Berth","Manuevering","Transit"),4),
                       "Anchorage","Berth","Manuevering"
              ),
...
test_that("calcAuxBoilerLoad Starcrest works",
          {
            ...
            testStarcrestAuxBoilerLoad<- data.table::data.table(
              ...
              opMode=c("Manuevering","Anchorage","Berth","Transit"),
...
test_that("calcAuxBoilerLoad works with inputTable",
          {
            ...
            #Run Calculation
            testOut<-data.table()
            testOut$aux<-calcAuxBoilerLoad(opMode = c("Transit","Manuevering","Berth","Anchorage"),
            ...
            testOut$boiler<-calcAuxBoilerLoad(opMode = c("Transit","Manuevering","Berth","Anchorage"),
                                              shipType = c("boat", "fruit", "boat", "fruit"),
                                              subType = c("kayak", "pear", "canoe", "apple"),
                                              output = "boiler",
                                              inputTableLocation = tmpName
